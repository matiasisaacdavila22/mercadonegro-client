...
const controller = require('../../controllers/api/productImageController');
...
router.post('/',verifyAdmin, upload.single('file'), validations.validetProductImage, controller.store);
