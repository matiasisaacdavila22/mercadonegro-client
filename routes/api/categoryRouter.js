...
let getstorage = getMulterStorageConfig('../../public/images/category','category');
...
router.get('/',verifyAdmin, controller.create);
...
router.post('/',verifyAdmin, upload.single('image'),validations.validetCategory, controller.store);
...
router.put('/', verifyManager, upload.single('image'), validations.validetCategory, controller.update);
